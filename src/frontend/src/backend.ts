...
import type { MarkResult as _MarkResult, UserProfile as _UserProfile } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async getLeaderboardStats(arg0: bigint): Promise<Array<LeaderboardEntry>> {
    ...
    async getProgress(): Promise<UserProfile | null> {
        if (this.processError) {
            try {
    ...
    async markGestureLearned(arg0: string, arg1: string): Promise<MarkResult> {
        if (this.processError) {
            try {
...
function from_candid_MarkResult_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MarkResult): MarkResult {
