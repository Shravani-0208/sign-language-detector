import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports } from "./index-CR4OlANc.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, c as usePresence, d as useIsomorphicLayoutEffect, L as LayoutGroupContext } from "./proxy-BTRa081w.js";
/**
...
function useGestureDetection() {
  const [gesture, setGesture] = reactExports.useState(null);
  ...
  const stableGestureRef = reactExports.useRef(null);
  const stableCountRef = reactExports.useRef(0);
  const startDetection = reactExports.useCallback(() => {
    setIsDetecting(true);
  ...
  const stopDetection = reactExports.useCallback(() => {
